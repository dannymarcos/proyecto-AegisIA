...
def execute_kraken_trade(symbol="XTBUSD", action=None, volume=None, ordertype="market", price=None, leverage=None):
    """Execute a trade on Kraken using XTBUSD as default symbol."""
    try:
        api_key = os.environ.get('KRAKEN_API_KEY')
        api_sec = os.environ.get('KRAKEN_PRIVATE_KEY')
...
def fetch_historical_data(symbol="XBTUSDT", interval=15, since=None):
    """
